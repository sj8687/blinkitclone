...
class BlinkitCategoryscreen extends StatefulWidget {
  const BlinkitCategoryscreen({Key? key}) : super(key: key);

  @override
  State<BlinkitCategoryscreen> createState() => _CategoryscreenState();
}

class _CategoryscreenState extends State<BlinkitCategoryscreen> {
